...
public class AuthenticationProviderConfig {
  ...
  private static final String AUTHORITIES_BY_USERNAME_QUERY = "select b.username, a.role from user_roles a, users b where b.username=? and a.userid=b.userid";

  private static final String USER_DATASOURCE = "java:comp/env/jdbc/UserDS";

  @Bean(name = "dataSource")
  public DataSource dataSource() {
    JndiDataSourceLookup lookup = new JndiDataSourceLookup();
    return lookup.getDataSource(USER_DATASOURCE);
  }
